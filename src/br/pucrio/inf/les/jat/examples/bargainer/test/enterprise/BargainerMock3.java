		...
		public void action() {
			...
			try {
				...
				for ( int x = 0; x < 3; x++ ) {
					...
					AgentController agentController = getContainerController().createNewAgent("auction_" + component, "br.pucrio.inf.les.jat.examples.bargainer.test.enterprise.AuctionMock3" , new Object[] {getAID(),enterprise,component,100.0f,msg.getReplyWith()});
