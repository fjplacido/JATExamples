...
public class EnterpriseAgent extends Agent {
	...
	private static DFAgentDescription dfd = null;
	...
	private class NegociationBehaviour extends SimpleBehaviour {
		...
		public void action() {
			...
			MessageTemplate performativeTemplate = MessageTemplate.or(MessageTemplate.MatchPerformative(ACLMessage.CFP),
					MessageTemplate.MatchPerformative(ACLMessage.CANCEL));
			MessageTemplate template = MessageTemplate.and(MessageTemplate.MatchReplyWith(replyWith),
			...
			if (msg != null) {
				if (msg.getPerformative() == ACLMessage.CFP) {
					...
					if (!replay) {
						...
						// Se o conte�do da mensagem estiver errado pode ocorrer um erro aqui.
						...
						if (Float.valueOf(price) > this.agent.getInitialComponentPrice()) {
							String content = "EMPRESA:" + agent.getLocalName() + ";COMPONENTE:" + this.component
									+ ";PRECO:" + this.agent.getInitialComponentPrice();
						...
						// TODO Tratar uma segunda requisi��o de pre�o de Bargainer para um produto.
