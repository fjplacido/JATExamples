...
public class EnterpriseMock3 extends JadeMockAgent {
	...
	private class MainBehaviour extends OneShotBehaviour {
		...
		private EnterpriseMock3 agent;

		public MainBehaviour(EnterpriseMock3 agent) {
			this.agent = agent;
		}
		...
		public void action() {
			...
			try {
				...
				for ( int x = 0; x < 3; x++ ) {
					...
					if ( componenteReceived.equalsIgnoreCase(agent.componente) && !agent.componente.equalsIgnoreCase("Egg") ) {
