...
public class BargainerMock4 extends JadeMockAgent {

	private List<Componente> componentes = null;

	public BargainerMock4() {
		...
		public void action() {
			...
			try {
				...
				for ( int x = 0; x < 3; x++ ) {
					...
					AgentController agentController = getContainerController().createNewAgent("auction_" + component, "br.pucrio.inf.les.jat.examples.bargainer.test.enterprise.AuctionMock4" , new Object[] {getAID(),enterprise,component,50.0f,msg.getReplyWith()});
