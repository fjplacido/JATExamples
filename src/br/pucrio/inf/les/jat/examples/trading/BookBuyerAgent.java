package br.pucrio.inf.les.jat.examples.trading;
...
/**
 * This class was addapted from JADE examples package.
 * It Represents an agent in JADE platform that acts as a 
 * book byer in a trade system.
 * 
 * @author roberta
 * 
 */
...
public class BookBuyerAgent extends Agent {
	...
	/*private class BookBuyerTickerBehaviour extends TickerBehaviour {
		...
		public BookBuyerTickerBehaviour(Agent agent,int time) {
			super(agent,time);
		}
	...
	private ACLMessage sendCFP() {
		...
		//Se sellerAgents for null pode ocorrer um erro n�o verifica do aqui.
